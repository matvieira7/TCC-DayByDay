    ...
    <div class="accordion accordion-flush" id="accordionFlushExample">
        <div class="accordion-item">
            ...
            <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                <div class="accordion-body">O DayByDay oferece um calendário online e blocos de notas que facilitam o planejamento de tarefas e compromissos. Você pode categorizar suas anotações e visualizar seus prazos de forma clara, ajudando a manter sua rotina organizada.</div>
            </div>
        </div>
        <div class="accordion-item">
            <h2 class="accordion-header">
            ...
            <div id="flush-collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                <div class="accordion-body">Sim! O DayByDay é acessível em qualquer dispositivo com internet, o que permite que você visualize e edite suas anotações e compromissos em qualquer lugar.</div>
            </div>
        </div>
        <div class="accordion-item">
            <h2 class="accordion-header">
            ...
            <div id="flush-collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                <div class="accordion-body">Não, as suas anotações são somente suas, e ninguém além de você pode acessá-las.</div>
            </div>
        </div>
        <div class="accordion-item">
            <h2 class="accordion-header">
            ...
            <div id="flush-collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                <div class="accordion-body">Não! O DayByDay é totalmente de graça, nós não cobramos nenhum valor e você pode criar quantas notas e eventos quiser, sem tempo limitado.</div>
            </div>
        </div>
        <div class="accordion-item">
            <h2 class="accordion-header">
